...
class Eventbrite
{
    ...
    public function get_categories($expand=array()) {
        return $this->client->get(sprintf("categories/"), $expand=$expand);
    }
    /**
     * get_category
     * GET /categories/:id/
    ...
    public function get_category($id, $expand=array()) {
        return $this->client->get(sprintf("categories/%s/", $id), $expand=$expand);
    }
    /**
     * get_subcategories
     * GET /subcategories/
    ...
    public function get_subcategories($expand=array()) {
        return $this->client->get(sprintf("subcategories/"), $expand=$expand);
    }
    /**
     * get_subcategory
    ...
    public function get_subcategory($id, $expand=array()) {
        return $this->client->get(sprintf("subcategories/%s/", $id), $expand=$expand);
    }
    /**
     * get_event_search
     * GET /events/search/
    ...
    public function get_event_search($expand=array()) {
        return $this->client->get(sprintf("events/search"), $expand=$expand);
    }
    /**
     * post_events
     * POST /events/
    ...
    public function post_event($id, $data=array()) {
        return $this->client->post(sprintf("events/%s/", $id), $data=$data);
    }
    /**
     * post_event_publish
    ...
    public function post_event_publish($id, $data=array()) {
        return $this->client->post(sprintf("events/%s/publish/", $id), $data=$data);
    }
    /**
    ...
    public function post_event_unpublish($id, $data=array()) {
        return $this->client->post(sprintf("events/%s/unpublish/", $id), $data=$data);
    }
    /**
     * post_event_cancel
    ...
    public function post_event_cancel($id, $data=array()) {
        return $this->client->post(sprintf("events/%s/cancel/", $id), $data=$data);
    }
    /**
     * delete_event
     * DELETE /events/:id/
    ...
    public function delete_event($id, $data=array()) {
        return $this->client->delete(sprintf("events/%s/", $id), $data=$data);
    }
    /**
    ...
    public function get_event_display_settings($id, $expand=array()) {
        return $this->client->get(sprintf("events/%s/display_settings/", $id), $expand=$expand);
    }
    /**
    ...
    public function post_event_display_settings($id, $data=array()) {
        return $this->client->post(sprintf("events/%s/display_settings/", $id), $data=$data);
    }
    /**
    ...
    public function get_event_ticket_classes($id, $expand=array()) {
        return $this->client->get(sprintf("events/%s/ticket_classes/", $id), $expand=$expand);
    }
    /**
    ...
    public function post_event_ticket_classes($id, $data=array()) {
        return $this->client->post(sprintf("events/%s/ticket_classes/", $id), $data=$data);
    }
    /**
    ...
    public function get_event_ticket_class($id, $ticket_class_id, $expand=array()) {
        return $this->client->get(sprintf("events/%s/ticket_classes/%s/", $id, $ticket_class_id), $expand=$expand);
    }
    /**
    ...
    public function post_event_ticket_class($id, $ticket_class_id, $data=array()) {
        return $this->client->post(sprintf("events/%s/ticket_classes/%s/", $id, $ticket_class_id), $data=$data);
    }
    /**
    ...
    public function delete_event_ticket_class($id, $ticket_class_id, $data=array()) {
        return $this->client->delete(sprintf("events/%s/ticket_classes/%s/", $id, $ticket_class_id), $data=$data);
    }
    /**
    ...
    public function get_event_canned_questions($id, $expand=array()) {
        return $this->client->get(sprintf("events/%s/canned_questions/", $id), $expand=$expand);
    }
    /**
     * get_event_questions
    ...
    public function get_event_questions($id, $expand=array()) {
        return $this->client->get(sprintf("events/%s/questions/", $id), $expand=$expand);
    }
    /**
     * get_event_question
    ...
    public function get_event_question($id, $question_id, $expand=array()) {
        return $this->client->get(sprintf("events/%s/questions/%s/", $id, $question_id), $expand=$expand);
    }
    /**
     * get_event_attendees
    ...
    public function get_event_attendees($id, $expand=array()) {
        return $this->client->get(sprintf("events/%s/attendees/", $id), $expand=$expand);
    }
    /**
     * get_event_attendee
    ...
    public function get_event_attendee($id, $attendee_id, $expand=array()) {
        return $this->client->get(sprintf("events/%s/attendees/%s/", $id, $attendee_id), $expand=$expand);
    }
    /**
     * get_event_orders
    ...
    public function get_event_orders($id, $expand=array()) {
        return $this->client->get(sprintf("events/%s/orders/", $id), $expand=$expand);
    }
    /**
     * get_event_discounts
    ...
    public function get_event_discounts($id, $expand=array()) {
        return $this->client->get(sprintf("events/%s/discounts/", $id), $expand=$expand);
    }
    /**
    ...
    public function post_event_discounts($id, $data=array()) {
        return $this->client->post(sprintf("events/%s/discounts/", $id), $data=$data);
    }
    /**
     * get_event_discount
    ...
    public function get_event_discount($id, $discount_id, $expand=array()) {
        return $this->client->get(sprintf("events/%s/discounts/%s/", $id, $discount_id), $expand=$expand);
    }
    /**
     * post_event_discount
    ...
    public function post_event_discount($id, $discount_id, $data=array()) {
        return $this->client->post(sprintf("events/%s/discounts/%s/", $id, $discount_id), $data=$data);
    }
    /**
    ...
    public function get_event_public_discounts($id, $expand=array()) {
        return $this->client->get(sprintf("events/%s/public_discounts/", $id), $expand=$expand);
    }
    /**
    ...
    public function post_event_public_discounts($id, $data=array()) {
        return $this->client->post(sprintf("events/%s/public_discounts/", $id), $data=$data);
    }
    /**
    ...
    public function get_event_public_discount($id, $discount_id, $expand=array()) {
        return $this->client->get(sprintf("events/%s/public_discounts/%s/", $id, $discount_id), $expand=$expand);
    }
    /**
    ...
    public function post_event_public_discount($id, $discount_id, $data=array()) {
        return $this->client->post(sprintf("events/%s/public_discounts/%s/", $id, $discount_id), $data=$data);
    }
    /**
    ...
    public function delete_event_public_discount($id, $discount_id, $data=array()) {
        return $this->client->delete(sprintf("events/%s/public_discounts/%s/", $id, $discount_id), $data=$data);
    }
    /**
    ...
    public function get_event_access_codes($id, $expand=array()) {
        return $this->client->get(sprintf("events/%s/access_codes/", $id), $expand=$expand);
    }
    /**
    ...
    public function post_event_access_codes($id, $data=array()) {
        return $this->client->post(sprintf("events/%s/access_codes/", $id), $data=$data);
    }
    /**
    ...
    public function get_event_access_code($id, $access_code_id, $expand=array()) {
        return $this->client->get(sprintf("events/%s/access_codes/%s/", $id, $access_code_id), $expand=$expand);
    }
    /**
    ...
    public function post_event_access_code($id, $access_code_id, $data=array()) {
        return $this->client->post(sprintf("events/%s/access_codes/%s/", $id, $access_code_id), $data=$data);
    }
    /**
     * get_event_transfers
    ...
    public function get_event_transfers($id, $expand=array()) {
        return $this->client->get(sprintf("events/%s/transfers/", $id), $expand=$expand);
    }
    /**
     * get_event_teams
     * GET /events/:id/teams/
    ...
    public function get_event_teams($id, $expand=array()) {
        return $this->client->get(sprintf("events/%s/teams/", $id), $expand=$expand);
    }
    /**
     * get_event_team
    ...
    public function get_event_team($id, $team_id, $expand=array()) {
        return $this->client->get(sprintf("events/%s/teams/%s/", $id, $team_id), $expand=$expand);
    }
    /**
    ...
    public function get_event_teams_attendees($id, $team_id, $expand=array()) {
        return $this->client->get(sprintf("events/%s/teams/%s/attendees/", $id, $team_id), $expand=$expand);
    }
    /**
     * post_series
     * POST /series/
    ...
    public function post_series($data=array()) {
        return $this->client->post(sprintf("series/"), $data=$data);
    }
    /**
     * get_one_series
     * GET /series/:id/
    ...
    public function get_one_series($id, $expand=array()) {
        return $this->client->get(sprintf("series/%s/", $id), $expand=$expand);
    }
    /**
     * post_one_series
     * POST /series/:id/
    ...
    public function post_one_series($id, $data=array()) {
        return $this->client->post(sprintf("series/%s/", $id), $data=$data);
    }
    /**
     * post_series_publish
    ...
    public function post_series_publish($id, $data=array()) {
        return $this->client->post(sprintf("series/%s/publish/", $id), $data=$data);
    }
    /**
    ...
    public function post_series_unpublish($id, $data=array()) {
        return $this->client->post(sprintf("series/%s/unpublish/", $id), $data=$data);
    }
    /**
     * post_series_cancel
    ...
    public function post_series_cancel($id, $data=array()) {
        return $this->client->post(sprintf("series/%s/cancel/", $id), $data=$data);
    }
    /**
     * delete_one_series
     * DELETE /series/:id/
    ...
    public function delete_one_series($id, $data=array()) {
        return $this->client->delete(sprintf("series/%s/", $id), $data=$data);
    }
    /**
     * get_series_events
    ...
    public function get_series_events($id, $expand=array()) {
        return $this->client->get(sprintf("series/%s/events/", $id), $expand=$expand);
    }
    /**
     * post_series_events
    ...
    public function post_series_events($id, $data=array()) {
        return $this->client->post(sprintf("series/%s/events/", $id), $data=$data);
    }
    /**
     * get_formatss
     * GET /formats/
    ...
    public function get_formatss($expand=array()) {
        return $this->client->get(sprintf("formats/"), $expand=$expand);
    }
    /**
     * get_formats
     * GET /formats/:id/
    ...
    public function get_formats($id, $expand=array()) {
        return $this->client->get(sprintf("formats/%s/", $id), $expand=$expand);
    }
    /**
     * get_media
     * GET /media/:id/
    ...
    public function get_media($id, $expand=array()) {
        return $this->client->get(sprintf("media/%s/", $id), $expand=$expand);
    }
    /**
     * get_media_upload
     * GET /media/upload/
    ...
    public function get_media_upload($expand=array()) {
        return $this->client->get(sprintf("media/upload/"), $expand=$expand);
    }
    /**
     * post_media_upload
     * POST /media/upload/
    ...
    public function post_media_upload($data=array()) {
        return $this->client->post(sprintf("media/upload/"), $data=$data);
    }
    /**
     * get_order
     * GET /orders/:id/
    ...
    public function get_order($id, $expand=array()) {
        return $this->client->get(sprintf("orders/%s/", $id), $expand=$expand);
    }
    /**
     * post_organizers
     * POST /organizers/
    ...
    public function post_organizer($id, $data=array()) {
        return $this->client->post(sprintf("organizers/%s/", $id), $data=$data);
    }
    /**
    ...
    public function get_organizers_events($id, $expand=array()) {
        return $this->client->get(sprintf("organizers/%s/events/", $id), $expand=$expand);
    }
    /**
     * get_refund_request
    ...
    public function get_refund_request($id, $expand=array()) {
        return $this->client->get(sprintf("refund_requests/%s/", $id), $expand=$expand);
    }
    /**
     * post_refund_request
    ...
    public function post_refund_request($id, $data=array()) {
        return $this->client->post(sprintf("refund_requests/%s/", $id), $data=$data);
    }
    /**
    ...
    public function post_refund_requests($data=array()) {
        return $this->client->post(sprintf("refund_requests/"), $data=$data);
    }
    /**
     * get_reports_sales
     * GET /reports/sales/
    ...
    public function get_reports_sales($expand=array()) {
        return $this->client->get(sprintf("reports/sales/"), $expand=$expand);
    }
    /**
    ...
    public function get_reports_attendees($expand=array()) {
        return $this->client->get(sprintf("reports/attendees/"), $expand=$expand);
    }
    /**
    ...
    public function get_system_timezones($expand=array()) {
        return $this->client->get(sprintf("system/timezones/"), $expand=$expand);
    }
    /**
     * get_system_regions
     * GET /system/regions/
    ...
    public function get_system_regions($expand=array()) {
        return $this->client->get(sprintf("system/regions/"), $expand=$expand);
    }
    /**
    ...
    public function get_system_countries($expand=array()) {
        return $this->client->get(sprintf("system/countries/"), $expand=$expand);
    }
    /**
    ...
    public function post_tracking_beacons($data=array()) {
        return $this->client->post(sprintf("tracking_beacons/"), $data=$data);
    }
    /**
     * get_tracking_beacon
    ...
    public function get_tracking_beacon($tracking_beacons_id, $expand=array()) {
        return $this->client->get(sprintf("tracking_beacons/%s/", $tracking_beacons_id), $expand=$expand);
    }
    /**
    ...
    public function post_tracking_beacon($tracking_beacons_id, $data=array()) {
        return $this->client->post(sprintf("tracking_beacons/%s/", $tracking_beacons_id), $data=$data);
    }
    /**
    ...
    public function delete_tracking_beacon($tracking_beacons_id, $data=array()) {
        return $this->client->delete(sprintf("tracking_beacons/%s/", $tracking_beacons_id), $data=$data);
    }
    /**
    ...
    public function get_event_tracking_beacons($event_id, $expand=array()) {
        return $this->client->get(sprintf("events/%s/tracking_beacons/", $event_id), $expand=$expand);
    }
    /**
    ...
    public function get_user_tracking_beacons($user_id, $expand=array()) {
        return $this->client->get(sprintf("users/%s/tracking_beacons/", $user_id), $expand=$expand);
    }
    /**
     * get_user
     * GET /users/:id/
    ...
    public function get_user($id, $expand=array()) {
        return $this->client->get(sprintf("users/%s/", $id), $expand=$expand);
    }
    /**
     * get_user_orders
     * GET /users/:id/orders/
    ...
    public function get_user_orders($id, $expand=array()) {
        return $this->client->get(sprintf("users/%s/orders/", $id), $expand=$expand);
    }
    /**
     * get_user_organizers
    ...
    public function get_user_organizers($id, $expand=array()) {
        return $this->client->get(sprintf("users/%s/organizers/", $id), $expand=$expand);
    }
    /**
    ...
    public function get_user_owned_events($id, $expand=array()) {
        return $this->client->get(sprintf("users/%s/owned_events/", $id), $expand=$expand);
    }
    /**
     * get_user_events
     * GET /users/:id/events/
    ...
    public function get_user_events($id, $expand=array()) {
        return $this->client->get(sprintf("users/%s/events/", $id), $expand=$expand);
    }
    /**
     * get_user_venues
     * GET /users/:id/venues/
    ...
    public function get_user_venues($id, $expand=array()) {
        return $this->client->get(sprintf("users/%s/venues/", $id), $expand=$expand);
    }
    /**
    ...
    public function get_user_owned_event_attendees($id, $expand=array()) {
        return $this->client->get(sprintf("users/%s/owned_event_attendees/", $id), $expand=$expand);
    }
    /**
    ...
    public function get_user_owned_event_orders($id, $expand=array()) {
        return $this->client->get(sprintf("users/%s/owned_event_orders/", $id), $expand=$expand);
    }
    /**
    ...
    public function get_user_contact_lists($id, $expand=array()) {
        return $this->client->get(sprintf("users/%s/contact_lists/", $id), $expand=$expand);
    }
    /**
    ...
    public function post_user_contact_lists($id, $data=array()) {
        return $this->client->post(sprintf("users/%s/contact_lists/", $id), $data=$data);
    }
    /**
    ...
    public function get_user_contact_list($id, $contact_list_id, $expand=array()) {
        return $this->client->get(sprintf("users/%s/contact_lists/%s/", $id, $contact_list_id), $expand=$expand);
    }
    /**
    ...
    public function post_user_contact_list($id, $contact_list_id, $data=array()) {
        return $this->client->post(sprintf("users/%s/contact_lists/%s/", $id, $contact_list_id), $data=$data);
    }
    /**
    ...
    public function delete_user_contact_list($id, $contact_list_id, $data=array()) {
        return $this->client->delete(sprintf("users/%s/contact_lists/%s/", $id, $contact_list_id), $data=$data);
    }
    /**
    ...
    public function get_user_contact_lists_contacts($id, $contact_list_id, $expand=array()) {
        return $this->client->get(sprintf("users/%s/contact_lists/%s/contacts/", $id, $contact_list_id), $expand=$expand);
    }
    /**
    ...
    public function post_user_contact_lists_contacts($id, $contact_list_id, $data=array()) {
        return $this->client->post(sprintf("users/%s/contact_lists/%s/contacts/", $id, $contact_list_id), $data=$data);
    }
    /**
    ...
    public function delete_user_contact_lists_contacts($id, $contact_list_id, $data=array()) {
        return $this->client->delete(sprintf("users/%s/contact_lists/%s/contacts/", $id, $contact_list_id), $data=$data);
    }
    /**
     * get_user_bookmarks
    ...
    public function get_user_bookmarks($id, $expand=array()) {
        return $this->client->get(sprintf("users/%s/bookmarks/", $id), $expand=$expand);
    }
    /**
    ...
    public function post_user_bookmarks_save($id, $data=array()) {
        return $this->client->post(sprintf("users/%s/bookmarks/save/", $id), $data=$data);
    }
    /**
    ...
    public function post_venue($id, $data=array()) {
        return $this->client->post(sprintf("venues/%s/", $id), $data=$data);
    }
    /**
     * post_venues
     * POST /venues/
    ...
    public function post_venues($data=array()) {
        return $this->client->post(sprintf("venues/"), $data=$data);
    }
    /**
     * get_venues_search
     * GET /venues/search/
    ...
    public function get_venues_search($expand=array()) {
        return $this->client->get(sprintf("venues/search/"), $expand=$expand);
    }
    /**
     * get_venues_events
    ...
    public function get_venues_events($id, $expand=array()) {
        return $this->client->get(sprintf("venues/%s/events/", $id), $expand=$expand);
    }
    /**
     * get_webhook
     * GET /webhooks/:id/
    ...
    public function get_webhook($id, $expand=array()) {
        return $this->client->get(sprintf("webhooks/%s/", $id), $expand=$expand);
    }
    /**
     * delete_webhook
     * DELETE /webhooks/:id/
    ...
    public function delete_webhook($id, $data=array()) {
        return $this->client->delete(sprintf("webhooks/%s/", $id), $data=$data);
    }
    /**
     * get_webhooks
     * GET /webhooks/
    ...
    public function get_webhooks($expand=array()) {
        return $this->client->get(sprintf("webhooks/"), $expand=$expand);
    }
    /**
     * post_webhooks
     * POST /webhooks/
    ...
    public function post_webhooks($data=array()) {
        return $this->client->post(sprintf("webhooks/"), $data=$data);
    }
